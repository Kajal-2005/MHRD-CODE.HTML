...
?>
    ...
    <a href="#" class="px-2">Screen Reader Access</a>
...
<header class="bg-white shadow-md py-4 px-6 flex justify-between items-center h-24">
    ...
    <div class="relative mr-20">
        <input type="text" id="search-input" placeholder="Search..." class="border rounded-lg px-3 py-2 pr-10">
...
<nav class="bg-blue-700 text-white py-2 px-6">
    <ul class="flex space-x-6">
        ...
        <li><a href="#" class="hover:underline">Initiatives & Reports</a></li>
        <li><a href="#" class="hover:underline">Statistics</a></li>
    </ul>
</nav>
...
<div class="w-full bg-gray-100 py-8">
        <h2 class="text-2xl font-bold text-center text-gray-800 mb-6">Major Initiatives</h2>
...
<div class="bg-gray-100 py-8">
    <div class="container mx-auto px-6 flex flex-col md:flex-row justify-between items-start">
        ...
        <div class="md:w-1/3">
            ...
            <a href="#" class="text-blue-600 font-semibold mt-2 inline-block">More Schemes</a>
        </div>

        <div class="mt-6 md:mt-0 md:w-2/3 flex flex-wrap justify-end space-x-20">
            
<!-- Scheme 1 -->
<div class="text-center">
    <a href="https://example.com/samagra-shiksha" class="block">
        <img src="images/samagra-shiksha.png" alt="Samagra Shiksha" class="w-24 h-24 mx-auto border rounded-lg shadow">
        <p class="mt-2 text-gray-800 hover:text-blue-600">Samagra Shiksha</p>
    </a>
</div>

<!-- Scheme 2 -->
<div class="text-center">
    <a href="https://example.com/pm-poshan" class="block">
        <img src="images/pm-poshan.png" alt="PM Poshan Scheme" class="w-24 h-24 mx-auto border rounded-lg shadow">
        <p class="mt-2 text-gray-800 hover:text-blue-600">PM Poshan Scheme</p>
    </a>
</div>

<!-- Scheme 3 -->
<div class="text-center">
    <a href="https://example.com/rashtriya-uchchatar" class="block">
        <img src="images/rashtriya-uchchatar.png" alt="Rashtriya Uchchatar Shiksha Abhiyan" class="w-24 h-24 mx-auto border rounded-lg shadow">
        <p class="mt-2 text-gray-800 hover:text-blue-600">Rashtriya Uchchatar Shiksha Abhiyan</p>
    </a>
</div>

<!-- Scheme 4 -->
<div class="text-center">
    <a href="https://example.com/unnat-bharat" class="block">
        <img src="images/unnat-bharat.png" alt="Unnat Bharat Abhiyan" class="w-24 h-24 mx-auto border rounded-lg shadow">
        <p class="mt-2 text-gray-800 hover:text-blue-600">Unnat Bharat Abhiyan</p>
    </a>
</div>
...
<section class="p-6 bg-white rounded-2xl shadow-lg mt-8">
  ...
  <div class="space-y-4">
    ...
    <div class="p-4 bg-blue-50 border-l-4 border-blue-400 rounded-lg shadow-sm">
      ...
      <p class="text-sm text-blue-700">Updated NEP 2025 guidelines are now available. <span class="block text-xs text-blue-500 mt-1">[April 10, 2025]</span></p>
    </div>

    <!-- Notification 2 -->
    <div class="p-4 bg-green-50 border-l-4 border-green-400 rounded-lg shadow-sm">
      <h3 class="text-lg font-semibold text-green-800">📘 Upcoming Policy Change: Teacher Training Mandate</h3>
      <p class="text-sm text-green-700">Digital training for teachers is mandatory by June 2025. <span class="block text-xs text-green-500 mt-1">[April 5, 2025]</span></p>
    </div>
    ...
    <div class="p-4 bg-purple-50 border-l-4 border-purple-400 rounded-lg shadow-sm">
      ...
      <p class="text-sm text-purple-700">Last date for submission: May 15, 2025. <span class="block text-xs text-purple-500 mt-1">[March 30, 2025]</span></p>
    </div>
    ...
    <div class="p-4 bg-red-50 border-l-4 border-red-400 rounded-lg shadow-sm">
      ...
      <p class="text-sm text-red-700">Exams start May 1st. Hall tickets release April 20th. <span class="block text-xs text-red-500 mt-1">[April 12, 2025]</span></p>
    </div>
  </div>
</section>
...
<!-- Map
<section class="bg-white p-6 rounded-2xl shadow-lg mt-8">
    <h2 class="text-2xl font-bold mb-4">📍 Interactive World Map</h2>
    <h1 class="text-lg font-semibold mb-2 text-gray-700">Check literacy rate of your state</h1>
    <div id="indiaMap" class="w-full h-[300px] rounded-xl border border-gray-300"></div>
</section> -->

<section class="bg-white p-6 rounded-2xl shadow-lg mt-8 flex">
    ...
    <div class="w-1/2 pl-4">
        <h2 class="text-lg font-semibold mb-2 text-gray-700 dark:text-gray-300">Top 5 Most Literate States</h2>
        <img src="top_literacy_graph.png" alt="Top 5 Most Literate States" class="w-full rounded-xl shadow-md">
        <p class="text-sm text-gray-500 mt-2">Source: [Insert your data source here]</p>
    </div>
</section>
<button id="theme-toggle" class="fixed bottom-4 right-4 bg-gray-200 dark:bg-gray-700 text-gray-800 dark:text-gray-200 p-2 rounded-full shadow-md">
    ☀️
</button>
